...
export const text = [
  {
    title: "Car Identity Verification Made Easy",
    text: "It is a fact that about eighty percent of vehicles stolen from people end up with innocent car buyers and sellers. This service helps protect you from the dangers of inadvertently buying these stolen vehicles which will not only get you into trouble with Law Enforcement, but also make you lose resources spent on buying the vehicle",
    subtitle: "Start Using Aigis App Today",
